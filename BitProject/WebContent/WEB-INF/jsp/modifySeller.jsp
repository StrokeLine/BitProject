			...
			<div class="sellerReg_contents">
				...
				<div class="accountReg" style="margin-bottom: 30px;">
					...
					<div class="accountReg_bankSel">				
						...
						계좌번호<input type="text" name="s_account" value="${seller_info.s_account}"><br>
						예금주명<input type="text" name="s_holder" value="${seller_info.s_holder}">
					</div>			
				</div>
				...
				<div class="offlineStore_reg" style="margin-bottom: 30px;">
					<h4>오프라인 스토어</h4>					
					주소  <input type="text" name="s_address" style="width: 450px;" value="${seller_info.s_address}">			
				</div>		
			</div>	
