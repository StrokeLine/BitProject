				...
				<div class="zzz">
					<!-- <div class="col-md-12 text-center user"> -->
						...
						<div class="social-icons" id="sellerMyStore-social-icons">
							...
							<div class="info_frame">
								<div class="frame_value" style="text-align: center;"><fmt:formatDate value="${seller_info.s_date}" pattern="yyyy-MM-dd"/></div>
								<div class="frame_value" style="text-align: center;">${seller_info.s_sale}</div>
						  ...
						  <div class="container-fluid">
						    ...
						    <div class="collapse navbar-collapse text-center" id="bs-example-navbar-collapse-1">
						      <ul class="nav navbar-nav">
						        <li class="nav-item"><a class="active" href="index.html">상품 더 보기</a></li>
						        <li class="nav-item"><a href="about.html">공지/알림</a></li>
						        <li class="nav-item"><a href="qAndAStore">문의하기</a></li>							        
						      </ul>
						    </div>/.navbar-collapse
						  </div>/.container-fluid
						</nav>
