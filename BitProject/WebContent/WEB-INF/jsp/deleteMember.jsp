...
<style>
	.deleteMain{
		margin: 3em 20em; padding: 0 10em;
	}
	...
	$.ajax({
        ...
        success : function(data) {
        	if(data){
        		...
        		parent.document.location.replace('main');
        	} else {
			...
			<div class="inner">
				...
				<div class="repassword">
					...
					<div class="memberInfoTable">
						...
						<div>
							<ul class="actions">
								<li><input class="button special small" type="button" value="확인" onclick='passwdCheck()'></li>						
								<li><input class="button special small" type="button" id="delete_btn" value="탈퇴하기" onclick="deleteMember()" disabled="disabled"/></li>
							</ul>
						</div>
					</div> 
				</div>
